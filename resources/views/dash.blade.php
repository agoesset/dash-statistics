                            ...
                            <div class="card-body px-4 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        <h6 class="text-muted font-semibold">Total Viewers ( Area Jakarta )</h6>
                        ...
                        <div class="card">
                            <div class="card-body px-4 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        <h6 class="text-muted font-semibold">Total Akun Dijangkau ( Area Jakarta )</h6>
                        ...
                        <div class="card">
                            <div class="card-body px-4 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        <h6 class="text-muted font-semibold">Biaya Per Viewers</h6>
                                        <h6 class="font-extrabold mb-0"> Rp {{ number_format($budget->biaya_perviewers, 0, ',', '.') }}</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body px-4 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        <h6 class="text-muted font-semibold">Total Dibelanjakan</h6>
                                        <h6 class="font-extrabold mb-0">Rp {{ number_format($budget->total_dibelanjakan, 0, ',', '.') }}</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
